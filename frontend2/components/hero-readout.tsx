  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 z-[3] pointer-events-none">
      <svg className="w-full h-[60px] block overflow-visible" viewBox="0 0 1200 60" preserveAspectRatio="none">
        <path d={ghostPath} stroke="#e0e8f2" strokeWidth="1" fill="none" />
        <path d={livePath} stroke="#003566" strokeWidth="1.5" fill="none" opacity="0.5" />
      </svg>
      <div className="flex justify-between items-center font-mono text-[0.7rem] tracking-[0.16em] uppercase text-ash px-5 md:px-14 pb-6 max-w-page mx-auto">
        <span>Attention</span>
